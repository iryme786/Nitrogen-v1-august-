...
# API Configuration
API_ID = int(os.environ.get("API_ID", "19259149"))
...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Ryme786:Ryme786@cluster0.8iyq8v0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "6705657501"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6559064772").split()]  # Default to owner ID

# Channel Configuration
PREMIUM_CHANNEL = "https://t.me/+QLrqFYC6ADgxMThl"
